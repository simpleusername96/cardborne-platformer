param(
    [string[]]$PaletteSpecs = @(
        "pixel-art-production/assets/palettes/pixel-hangar-v1.json",
        "pixel-art-production/assets/palettes/semantic-mask-v1.json"
    )
)
...
$designTools = Join-Path $workspaceRoot "tools/design"
