param(
    [string]$PlayerManifestPath = "pixel-art-production/assets/examples/player-craft.manifest.json",
    [string]$PlayerBriefPath = "pixel-art-production/assets/examples/player-craft.brief.json",
    [string]$PlayerBuildDirectory = "pixel-art-production/assets/examples/player-craft-build-v2",
    [string]$ProjectileManifestPath = "pixel-art-production/assets/examples/projectile-proof/projectile.manifest.json",
    [string]$ProjectileBriefPath = "pixel-art-production/assets/examples/projectile-proof/projectile.brief.json",
    [string]$ProjectileBuildDirectory = "pixel-art-production/assets/examples/projectile-proof/build",
    [string]$CatalogPath = "pixel-art-production/assets/examples/proof-catalog.json"
)
...
try {
    ...
    & (Join-Path $PSScriptRoot "validate_pixel_asset_import_settings.ps1")
    ...
    $duplicatePalette = Get-Content -LiteralPath (Resolve-RepoPath -Path "pixel-art-production/assets/palettes/pixel-hangar-v1.json") -Raw | ConvertFrom-Json
    ...
    $badPolicy = Get-Content -LiteralPath (Resolve-RepoPath -Path "pixel-art-production/assets/pixel-import-policy.json") -Raw | ConvertFrom-Json
