...
function Build-SemanticLayers {
    ...
    $manifestPath = "pixel-art-production/evidence/pipeline-sampler/manifests/$Id.manifest.json"
...
$displayPaletteSpec = "pixel-art-production/evidence/pipeline-sampler/palette/pixel-hangar-v1-sampler.json"
$displayPalette = "pixel-art-production/evidence/pipeline-sampler/palette/pixel-hangar-v1-sampler.png"
$semanticPaletteSpec = "pixel-art-production/evidence/pipeline-sampler/palette/semantic-mask-v1-sampler.json"
$semanticPalette = "pixel-art-production/evidence/pipeline-sampler/palette/semantic-mask-v1-sampler.png"
...
foreach ($asset in $generatedAssets) {
    $rawPath = "pixel-art-production/evidence/pipeline-sampler/raw/$($asset.id).png"
    $nativePath = "pixel-art-production/evidence/pipeline-sampler/native/$($asset.id).png"
