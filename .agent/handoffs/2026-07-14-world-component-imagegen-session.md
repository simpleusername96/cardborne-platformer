...
The owner requested an inspectable temporary HTML component gallery. It has not been
implemented.
...
The next session should revise the gallery data model to support `base_parts` and
