...
func _build_authored_route() -> void:
	...
	_add_climbable(test_objects, "RopeClimb", Vector2(1370.0, 1300.0), Vector2(44.0, 1050.0))
	_add_platform(world, "RopeTopOneWay", Vector2(1340.0, UPPER_FLOOR_Y - 3.0), Vector2(130.0, 22.0), Color(0.23, 0.48, 0.56, 1.0), true)
	...
	_add_checkpoint(test_objects, "CheckpointClimbPrep", Vector2(1370.0, GROUND_TOP - PLAYER_FOOT_OFFSET), "climb_prep")
	...
	_add_label(world, "OPTIONAL HIGH CACHE\nDouble jump branch / later upgrade reward.", Vector2(900.0, 455.0), 400.0)
