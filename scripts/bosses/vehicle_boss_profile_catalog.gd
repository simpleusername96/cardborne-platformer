...
const PROFILES: Array[Dictionary] = [
	{"health":16900.0, "move_speed":405.0, "attack_move_speed":251.1, "initial_autonomous_delay":2.144, "read_gaps":[0.268, 0.201, 0.1608], "autonomous_intervals":[3.216, 2.613, 2.077], "default_radius":262.5, "default_width":68.0, "lane_spacing":135.0, "fan_offsets":[-0.34, -0.17, 0.0, 0.17, 0.34]},
	{"health":21300.0, "move_speed":420.0, "attack_move_speed":268.8, "initial_autonomous_delay":2.080, "read_gaps":[0.260, 0.195, 0.1560], "autonomous_intervals":[3.120, 2.535, 2.015], "default_radius":273.0, "default_width":70.72, "lane_spacing":140.4, "fan_offsets":[-0.3536, -0.1768, 0.0, 0.1768, 0.3536]},
	{"health":28300.0, "move_speed":435.0, "attack_move_speed":287.1, "initial_autonomous_delay":2.016, "read_gaps":[0.252, 0.189, 0.1512], "autonomous_intervals":[3.024, 2.457, 1.953], "default_radius":283.5, "default_width":73.44, "lane_spacing":145.8, "fan_offsets":[-0.3672, -0.1836, 0.0, 0.1836, 0.3672]},
	...
	{"health":122300.0, "move_speed":545.0, "attack_move_speed":441.45, "initial_autonomous_delay":1.600, "read_gaps":[0.200, 0.150, 0.1200], "autonomous_intervals":[2.400, 1.950, 1.550], "default_radius":351.75, "default_width":91.12, "lane_spacing":180.9, "fan_offsets":[-0.4556, -0.2278, 0.0, 0.2278, 0.4556]},
