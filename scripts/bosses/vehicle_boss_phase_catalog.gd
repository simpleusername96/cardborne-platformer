...
const PHASES := {
	...
	&"stage_2": {"variant": &"boss_stage_02", "shield_kind": &"none", "add_roles": {2: [&"ordinary_gunner_t1", &"ordinary_gunner_t1", &"ordinary_defender_t1", &"ordinary_gunner_t1"], 3: [&"ordinary_gunner_t1", &"ordinary_defender_t1", &"ordinary_gunner_t1", &"ordinary_defender_t1"]}, "tactic_ids": {2: &"crossfire_convoy", 3: &"shielded_column"}},
	&"stage_3": {"variant": &"boss_stage_03", "shield_kind": &"frontal_intercept", "add_roles": {2: [&"ordinary_gunner_t1", &"ordinary_gunner_t1", &"ordinary_defender_t1", &"ordinary_gunner_t1"], 3: [&"ordinary_defender_t1", &"ordinary_coordinator_t1", &"ordinary_defender_t1", &"ordinary_pursuer_t1"]}, "tactic_ids": {2: &"crossfire_convoy", 3: &"shielded_column"}},
	...
	&"stage_5": {"variant": &"boss_stage_05", "shield_kind": &"none", "add_roles": {2: [&"ordinary_charger_t2", &"ordinary_pursuer_t2", &"ordinary_charger_t2", &"ordinary_pursuer_t2"], 3: [&"ordinary_gunner_t2", &"ordinary_gunner_t2", &"ordinary_defender_t2", &"ordinary_gunner_t2"]}, "tactic_ids": {2: &"spearhead", 3: &"crossfire_convoy"}},
	&"stage_6": {"variant": &"boss_stage_06", "shield_kind": &"none", "add_roles": {2: [&"ordinary_gunner_t2", &"ordinary_gunner_t2", &"ordinary_defender_t2", &"ordinary_gunner_t2"], 3: [&"ordinary_gunner_t2", &"ordinary_defender_t2", &"ordinary_gunner_t2", &"ordinary_defender_t2"]}, "tactic_ids": {2: &"crossfire_convoy", 3: &"shielded_column"}},
	...
	&"stage_8": {"variant": &"boss_stage_08", "shield_kind": &"none", "add_roles": {2: [&"ordinary_coordinator_t2", &"ordinary_defender_t2", &"ordinary_pursuer_t2", &"ordinary_defender_t2"], 3: [&"ordinary_gunner_t2", &"ordinary_gunner_t2", &"ordinary_defender_t2", &"ordinary_gunner_t2"]}, "tactic_ids": {2: &"shepherd_pack", 3: &"crossfire_convoy"}},
	...
	&"stage_11": {"variant": &"boss_stage_11", "shield_kind": &"none", "add_roles": {2: [&"ordinary_gunner_t3", &"ordinary_gunner_t3", &"ordinary_defender_t3", &"ordinary_gunner_t3"], 3: [&"ordinary_gunner_t3", &"ordinary_defender_t3", &"ordinary_gunner_t3", &"ordinary_defender_t3"]}, "tactic_ids": {2: &"crossfire_convoy", 3: &"shielded_column"}},
	&"stage_12": {"variant": &"boss_stage_12", "shield_kind": &"none", "add_roles": {2: [&"ordinary_coordinator_t3", &"ordinary_defender_t3", &"ordinary_pursuer_t3", &"ordinary_defender_t3"], 3: [&"ordinary_gunner_t3", &"ordinary_gunner_t3", &"ordinary_defender_t3", &"ordinary_gunner_t3"]}, "tactic_ids": {2: &"shepherd_pack", 3: &"crossfire_convoy"}},
}
