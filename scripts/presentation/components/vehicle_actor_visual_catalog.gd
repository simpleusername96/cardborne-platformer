...
const DESCRIPTORS := {
	...
	&"forge_plate": {"role": &"boss_module", "shape": &"twin_plate", "color": &"boss_command"},
	&"segment_lock": {"role": &"boss_module", "shape": &"side_lock", "color": &"boss_command"},
	&"relay_positive": {"role": &"boss_module", "shape": &"positive_relay", "color": &"boss_command"},
	&"relay_negative": {"role": &"boss_module", "shape": &"negative_relay", "color": &"boss_command"},
	&"route_switch": {"role": &"boss_module", "shape": &"route_fork", "color": &"boss_command"},
	&"armor_car": {"role": &"boss_module", "shape": &"twin_armor", "color": &"boss_command"},
	&"lattice_outer": {"role": &"boss_module", "shape": &"lattice_node", "color": &"boss_command"},
