...
const DESCRIPTORS := {
	...
	&"ordinary_emitter_t1": {"role": &"emitter", "asset": &"actor/ordinary_emitter_t1", "color": &"danger", "states": [&"base", &"trait", &"collective"]},
	&"ordinary_emitter_t2": {"role": &"emitter", "asset": &"actor/ordinary_emitter_t2", "color": &"danger", "states": [&"base", &"trait", &"collective"]},
	&"ordinary_emitter_t3": {"role": &"emitter", "asset": &"actor/ordinary_emitter_t3", "color": &"danger", "states": [&"base", &"trait", &"collective"]},
