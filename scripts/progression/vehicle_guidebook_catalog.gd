...
const ENTRIES: Array[Dictionary] = [
	...
	{"id":&"mobile_rail_sniper", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"rail_sniper", "name_key":"ENEMY_MOBILE_RAIL_SNIPER"},
	{"id":&"mobile_orbit_gunner", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"orbit_gunner", "name_key":"ENEMY_ORBIT_GUNNER"},
	{"id":&"mobile_bombing_runner", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"bombing_runner", "name_key":"ENEMY_BOMBING_RUNNER"},
	{"id":&"mobile_wreck_scavenger", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"wreck_scavenger", "name_key":"ENEMY_WRECK_SCAVENGER"},
	...
	{"id":&"boss_stage_6", "category":&"bosses", "entry_kind":&"boss", "boss_stage_index":5, "name_key":"ENEMY_SIEGE_BATTERY", "preview":{"kind":&"boss", "id":&"battery"}},
	{"id":&"boss_stage_7", "category":&"bosses", "entry_kind":&"boss", "boss_stage_index":6, "name_key":"ENEMY_VECTOR_LOOM", "preview":{"kind":&"boss", "id":&"loom"}},
	{"id":&"boss_stage_8", "category":&"bosses", "entry_kind":&"boss", "boss_stage_index":7, "name_key":"ENEMY_PULSE_CORE", "preview":{"kind":&"boss", "id":&"pulse_core"}},
