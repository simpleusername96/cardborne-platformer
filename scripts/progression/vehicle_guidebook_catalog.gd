...
const ENEMY_ENTRY_IDS := {
	...
	&"ordinary_gunner_t1":&"enemy_ordinary_gunner_t1",
	&"ordinary_gunner_t2":&"enemy_ordinary_gunner_t2",
	&"ordinary_gunner_t3":&"enemy_ordinary_gunner_t3",
...
const ENTRIES: Array[Dictionary] = [
	...
	{"id":&"enemy_ordinary_gunner_t1", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"ordinary_gunner_t1", "name_key":"ORDINARY_GUNNER_T1"},
	{"id":&"enemy_ordinary_gunner_t2", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"ordinary_gunner_t2", "name_key":"ORDINARY_GUNNER_T2"},
	{"id":&"enemy_ordinary_gunner_t3", "category":&"enemies", "entry_kind":&"enemy", "archetype":&"ordinary_gunner_t3", "name_key":"ORDINARY_GUNNER_T3"},
	...
	{"id":&"object_trait_artillery", "category":&"enemies", "entry_kind":&"trait", "family_trait":&"artillery", "name_key":"TRAIT_ARTILLERY", "preview":{"kind":&"enemy", "id":&"ordinary_gunner_t1"}},
	{"id":&"object_trait_slow", "category":&"enemies", "entry_kind":&"trait", "family_trait":&"slow", "name_key":"TRAIT_SLOW", "preview":{"kind":&"enemy", "id":&"ordinary_gunner_t1"}},
