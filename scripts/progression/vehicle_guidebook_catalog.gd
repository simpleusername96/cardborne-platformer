...
const ENTRIES: Array[Dictionary] = [
	...
	{"id":&"mobile_spark_minelet", "category":&"mobile", "name_key":"ENEMY_SPARK_MINELET", "description_key":"GUIDE_MOBILE_MINELET_DESC", "preview":{"kind":&"enemy", "id":&"spark_minelet"}},
	...
	{"id":&"boss_stage_1", "category":&"bosses", "name_key":"ENEMY_FOUNDRY_COLOSSUS", "description_key":"GUIDE_BOSS_1_DESC", "preview":{"kind":&"boss", "id":&"colossus"}},
	{"id":&"boss_stage_2", "category":&"bosses", "name_key":"ENEMY_ARCHIVE_LEVIATHAN", "description_key":"GUIDE_BOSS_2_DESC", "preview":{"kind":&"boss", "id":&"leviathan"}},
	{"id":&"boss_stage_3", "category":&"bosses", "name_key":"ENEMY_DRYDOCK_TITAN", "description_key":"GUIDE_BOSS_3_DESC", "preview":{"kind":&"boss", "id":&"titan"}},
	{"id":&"boss_stage_4", "category":&"bosses", "name_key":"ENEMY_SWITCHYARD_BEHEMOTH", "description_key":"GUIDE_BOSS_4_DESC", "preview":{"kind":&"boss", "id":&"behemoth"}},
	{"id":&"boss_stage_5", "category":&"bosses", "name_key":"ENEMY_CROWN_ENGINE", "description_key":"GUIDE_BOSS_5_DESC", "preview":{"kind":&"boss", "id":&"crown"}},
