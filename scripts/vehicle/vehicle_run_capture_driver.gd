...
const CORE_CAPTURE_FILES := [
	...
	"04-three-cycles-threat-radar.png",
	"05-two-field-items.png",
	"06-level-up-choice.png",
	"06b-level-up-selected.png",
	"06c-level-up-confirmed.png",
	"06d-localization-third-slot.png",
...
const FULL_CAPTURE_FILES := [
	...
	"30-boss-01-stage-1-sealed-hit.png",
