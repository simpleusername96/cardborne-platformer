...
const LEGAL_TRANSITIONS: Dictionary = {
	...
	Value.STAGE_ACTIVE: [
		Value.LEVEL_REWARD, Value.STAGE_CARD_REWARD, Value.RUN_DEATH, Value.RUN_CLEAR,
	],
	Value.LEVEL_REWARD: [
		Value.LEVEL_REWARD, Value.STAGE_ACTIVE, Value.STAGE_CARD_REWARD,
		Value.RUN_DEATH, Value.RUN_CLEAR,
	],
	Value.STAGE_CARD_REWARD: [Value.STAGE_LOADING, Value.REST_FORGE, Value.RUN_DEATH],
