...
- [ ] Update canonical product/design contracts and active-weapon resource schema; migrate all four resources and runtime snapshots to range, duration, strength, and cooldown.
