...
- [ ] Compare exact-commit evidence with the performance policy. Keep physics, frame pacing, draw, and scenario-validity gates intact. Align only the combat-batch validator to the canonical visual limit of 80.
- [ ] Update accepted product documentation and this plan's progress with measured results, applicability, and any remaining risk.
