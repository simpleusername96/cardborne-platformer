...
## Proposed Core Play Work

The following documents are the current review package for shifting the next
milestone from content breadth to a measured Core Play Proof. They remain proposed
until the owner accepts the scope and the implementation plan activates individual
contracts:
