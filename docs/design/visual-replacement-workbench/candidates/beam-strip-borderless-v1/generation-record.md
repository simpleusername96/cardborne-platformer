...
approves the exact 128x32 image and rendered Fixed Beam Ordinary Enemy Lv.1/boss startup and active states.
...
- The current `cue_beam_strip_9.png` and Stage 5 boss raster were also supplied as footprint and
...
- Shared by Fixed Beam Ordinary Enemy Lv.1 and straight boss beams.
...
dedicated Stage 5 boss-beam startup and active fixtures. The original production raster was restored to
SHA-256 `f30a3e2027de9e3580973d1e54051617e7b5f87e58571d768f6ad558b2924e48`
after candidate capture. Exact AS-IS and TO-BE Fixed Beam Ordinary Enemy Lv.1/Stage 5 boss startup and active images are
