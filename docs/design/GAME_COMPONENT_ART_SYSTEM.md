...
scope: Proposed terrain-tile, reusable-component, stage-skin, decoration, and unique-set-piece boundaries
...
The generated boards under `docs/design/references/` are exploratory direction and
decomposition references. They are not accepted production direction, atlases, or
sprite sheets.
