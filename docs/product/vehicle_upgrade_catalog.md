...
| `lifesteal` | 흡혈 / Lifesteal | 2 | 적에게 실제로 적용된 플레이어 소유 피해를 기준으로 선체를 회복한다. L1: 피해의 2%. L2: 피해의 3.5%. 회복 예산은 최대 6이며 초당 6씩 보충되고, 현재 최대 선체를 넘지 않는다. |
...
- `흡혈 / Lifesteal`이 실제 적용 피해의 2%/3.5%를 선체로 회복하고,
  초당 6 회복 예산과 최대 선체 한도를 지킨다.
