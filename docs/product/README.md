...
`2d_platform_action_card_game_prd.md` is the single product source of truth for
Cardborne and the first complete run. It already incorporates the retired scope
delta and first-slice expansion.
...
through Git history but do not define current work.
