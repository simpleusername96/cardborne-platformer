...
var _captures: Array[Dictionary] = [
	...
	{"name": "flooded_descent_preview", "size": Vector2i(1280, 720), "stage_index": 1, "target": &"fw_flooded_entry", "anchor": &"PumpPreview"},
	{"name": "flooded_rope_descent", "size": Vector2i(1280, 720), "stage_index": 1, "target": &"fw_rope_shaft", "anchor": &"RopeClimb"},
	{"name": "flooded_leaper_commitment", "size": Vector2i(1280, 720), "stage_index": 1, "target": &"fw_leaper_basin", "anchor": &"CommitmentPreview"},
	...
	{"name": "flooded_pump_ascent", "size": Vector2i(1280, 720), "stage_index": 1, "target": &"fw_pump_gallery", "anchor": &"MidRecoveryBand"},
	{"name": "flooded_exit_release", "size": Vector2i(1280, 720), "stage_index": 1, "target": &"fw_exit_shelter", "anchor": &"ArrivalView"},
