...
func _validate_family_coverage() -> void:
	var expected := {
		&"ordinary_pursuer_t1":Policy.PURSUIT,
		&"ordinary_pursuer_t2":Policy.PURSUIT,
		&"ordinary_pursuer_t3":Policy.PURSUIT,
		&"ordinary_charger_t1":Policy.PURSUIT,
		&"ordinary_charger_t2":Policy.PURSUIT,
		&"ordinary_charger_t3":Policy.PURSUIT,
		&"ordinary_emitter_t1":Policy.STANDOFF,
		&"ordinary_emitter_t2":Policy.STANDOFF,
		&"ordinary_emitter_t3":Policy.STANDOFF,
		&"ordinary_defender_t1":Policy.ESCORT,
		&"ordinary_defender_t2":Policy.ESCORT,
		&"ordinary_defender_t3":Policy.ESCORT,
		&"ordinary_coordinator_t1":Policy.SUPPORT,
		&"ordinary_coordinator_t2":Policy.SUPPORT,
		&"ordinary_coordinator_t3":Policy.SUPPORT,
		&"boss_pattern_fixed_beam_01":Policy.STATIONARY,
