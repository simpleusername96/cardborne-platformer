...
func _initialize() -> void:
	...
	for locale in ["ko", "en"]:
		...
		for entry_key in [
			...
			"NOTIFY_FACILITY_REPAIR_ACTIVATED",
			"NOTIFY_FACILITY_BARRIER_ACTIVATED",
			"NOTIFY_FACILITY_GRAVITY_ACTIVATED",
			"NOTIFY_FACILITY_CRYO_ACTIVATED",
			"NOTIFY_FACILITY_WEAKPOINT_ACTIVATED",
			"NOTIFY_FACILITY_EXPIRY_WARNING",
			"NOTIFY_FACILITY_SHUTDOWN",
		]:
