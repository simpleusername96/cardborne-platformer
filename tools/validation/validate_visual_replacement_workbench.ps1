...
try {
    ...
    Expect ($actual.summary.units -eq 30) 'switch unit count must be 30'
    ...
    Expect ($actual.summary.final_gameplay_png -eq 100) 'final gameplay PNG forecast must be 100'
    ...
    Expect ($actual.summary.authored_gameplay_png -eq 98) 'authored gameplay PNG output count must be 98'
