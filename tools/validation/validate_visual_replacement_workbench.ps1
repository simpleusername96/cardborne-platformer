...
try {
    ...
    Expect ($actual.summary.gameplay_png -eq 80) 'production gameplay PNG count must be 80'
    Expect ($actual.summary.final_gameplay_png -eq 89) 'final gameplay PNG forecast must be 89'
    ...
    Expect ($actual.summary.gameplay_images -eq 83) 'production gameplay image count must be 83'
    Expect ($actual.summary.authored_gameplay_png -eq 87) 'authored gameplay PNG output count must be 87'
