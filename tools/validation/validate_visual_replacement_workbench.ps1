...
try {
    ...
    Expect ($actual.summary.gameplay_png -eq 77) 'production gameplay PNG count must be 77'
    Expect ($actual.summary.final_gameplay_png -eq 86) 'final gameplay PNG forecast must be 86'
    ...
    Expect ($actual.summary.gameplay_images -eq 80) 'production gameplay image count must be 80'
    Expect ($actual.summary.authored_gameplay_png -eq 84) 'authored gameplay PNG output count must be 84'
