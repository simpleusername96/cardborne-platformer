...
try {
    ...
    Expect ($actual.summary.gameplay_png -eq 91) 'production gameplay PNG count must be 91'
    ...
    Expect ($actual.summary.gameplay_images -eq 94) 'production gameplay image count must be 94'
