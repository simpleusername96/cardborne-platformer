...
try {
    ...
    Expect ($actual.summary.final_gameplay_png -eq 87) 'final gameplay PNG forecast must be 87'
    ...
    Expect ($actual.summary.authored_gameplay_png -eq 85) 'authored gameplay PNG output count must be 85'
